...
nav: {
    ...
    auth: {
      ...
      forgotText: "Enter your email. You'll receive a link to reset your password.",
      forgotBtn: "Send link",
      forgotSent: "If an account exists, an email has been sent.",
    ...
    admin: {
      ...
      roleManager: "Manager",
      role: "Role",
      roleHelp: "ADMIN: full access. MANAGER: catalog & orders. CUSTOMER: buyer.",
      blocked: "Blocked",
      block: "Block",
      unblock: "Unblock",
