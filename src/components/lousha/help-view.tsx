...
export function HelpView() {
  ...
  const topics = lang === "fr" ? [
    { icon: ShoppingBag, title: "Passer une commande", text: "Ajoutez vos produits au panier puis cliquez sur « Commander ». Vous pouvez aussi commander via WhatsApp.", action: () => setView("shop") },
    ...
    { icon: Truck, title: "Livraison", text: "La livraison est gérée hors site. Contactez-nous pour les détails et délais.", action: () => setView("contact") },
    { icon: Package, title: "Suivi de commande", text: "Consultez « Mon compte » pour voir le statut de vos commandes.", action: () => setView("account") },
    { icon: RefreshCw, title: "Retours", text: "Chaque pièce étant unique, les retours sont évalués au cas par cas. Contactez-nous.", action: () => setView("contact") },
    { icon: ShieldCheck, title: "Qualité garantie", text: "Chaque pièce est vérifiée à la main. Nos produits sont en raphia 100% naturel fait main au Togo.", action: () => setView("material") },
  ] : [
    { icon: ShoppingBag, title: "Place an order", text: "Add products to cart then click 'Checkout'. You can also order via WhatsApp.", action: () => setView("shop") },
    ...
    { icon: Truck, title: "Delivery", text: "Delivery is managed offline. Contact us for details and timelines.", action: () => setView("contact") },
    { icon: Package, title: "Order tracking", text: "Check 'My account' to see your order status.", action: () => setView("account") },
    { icon: RefreshCw, title: "Returns", text: "Since each piece is unique, returns are evaluated case by case. Contact us.", action: () => setView("contact") },
    { icon: ShieldCheck, title: "Quality guaranteed", text: "Each piece is hand-checked. Our products are 100% natural raffia handmade in Togo.", action: () => setView("material") },
  ];
